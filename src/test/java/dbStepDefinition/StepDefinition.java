...
public class StepDefinition {
    ...
    public void staff_tablosundaki_ler_listelenir(String id) {
    ...
    @Given("{string} numarasi verilen customerin {string} guncellenir")
    public void numarasi_verilen_customerin_guncellenir(String id, String adresi) throws SQLException {
        update("UPDATE u480337000_tlb_training.customer_addresses SET address= '"+adresi+"' WHERE id="+id);


    }
    @Given("customer {string} tablosundaki adress bilgileri listelenir")
    public void customer_tablosundaki_adress_bilgileri_listelenir(String adres) {

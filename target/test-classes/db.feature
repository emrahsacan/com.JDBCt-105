Feature: DB_sorgulama
  ...
  ##INSERT INTO u480337000_tlb_training.users(first_name, last_name, username, email, id, role_id, password) values
  # ('ahmet', 'karli', 'karliahmet', 'ahmetkarli@gmail.com', 72,2, '123123123');
